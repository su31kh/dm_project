  ...
  (function() {
    ...
    var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//,
      ...
      Pc = function(a, b, c) {
        ...
        e.open("POST", (c || "https://web.archive.org/web/20180819202221/https://ampcid.google.com/v1/publisher:getClientId") + "?key=AIzaSyA65lEHUEizIsNtlbNo-l2K18dT680nsaM", !0);
        e.withCredentials = !0;
    ...
    var oe = function() {
        return (Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//web.archive.org/web/20180819202221/https://www.google-analytics.com"
      },
      Da = function(a) {
        this.name = "len";
        this.message = a + "-8192"
          ...
          if (4 == g.readyState) {
            if (d) try {
              ...
              if (1 > a.length) ge("xhr", "ver", "0"), c();
                ...
                var b = a.charAt(1);
                if ("d" == b) pe("https://web.archive.org/web/20180819202221/https://stats.g.doubleclick.net/j/collect",
                  d.U, d, c);
                else if ("g" == b) {
                  var e = "https://web.archive.org/web/20180819202221/https://www.google.%/ads/ga-audiences".replace("%", "com");
                  wc(e, d.google, c);
                  var w = a.substring(2);
                  if (w)
                    if (/^[a-z.]{1,6}$/.test(w)) {
                      var ha = "https://web.archive.org/web/20180819202221/https://www.google.%/ads/ga-audiences".replace("%", w);
                      wc(ha, d.google, ua)
                    } else ge("tld", "bcc", w)
                } else ge("xhr", "brc", b), c()
              }
      ...
      ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") ||
          (a = ["t=error", "_e=" + a, "_v=j68", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc("https://web.archive.org/web/20180819202221/https://www.google-analytics.com/u/d", a.join("&"), ua))
      };
    var h = function(a) {
    ...
    var p = /^(GTM|OPT)-[A-Z0-9]+$/,
      ...
      t = function(a) {
        ...
        var c = "https://web.archive.org/web/20180819202221/https://www.google-analytics.com/gtm/js?id=" + K(a.id);
        ...
        b.set(Xb, function(b) {
          ...
          if (se(b)) {
            if (ne() !== H(a, b)) {
              ...
              pe("https://web.archive.org/web/20180819202221/https://stats.g.doubleclick.net/j/collect", e.U, e)
            } else ta(re(a, b, 0));
            b.set(ed, "", !0)
          }
          return c
    ...
    var fd = function(a, b) {
      ...
      if (!a.get("dcLoaded")) {
        ...
        var d;
        b[U] && (d = Cc(b[U]));
        b = new Jd(a, "https://web.archive.org/web/20180819202221/https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&", d);
        Rd(b, a);
        a.set("dcLoaded", !0)
      }
    };
    ...
    var ad, bd = function(a, b, c) {
      if (!ad) {
        ...
        var e = O.name,
          g = /^#?gaso=([^&]*)/;
        if (e = (d = (d = d && d.match(g) || e && e.match(g)) ? d[1] : Ca("GASO")[0] || "") && d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i)) zc("GASO", "" + d, c, b, a, 0), window._udo || (window._udo = b), window._utcp || (window._utcp = c), a = e[1], wa("https://web.archive.org/web/20180819202221/https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&" : "") + hd(), "_gasojs");
        ad = !0
      }
    };
    ...
    var u = function(a, b, c) {
      ...
      y = function(a, b, c, d, e) {
        if (!ea(Yd.get(b)) && !$d.get(b)) {
          ...
          c && (c && 0 <= c.indexOf("/") || (c = (Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//web.archive.org/web/20180819202221/https://www.google-analytics.com/plugins/ua/" + c), d = ae(c), a = d.protocol, c = M.location.protocol,
      ...
      B = function(a) {
        ...
        if (D(a.url, "https://web.archive.org/web/20180819202221/https://www.google-analytics.com/gtm/js?id=")) return !0;
        ...
        if ("https:" != M.location.protocol && !Ba) {
          a: {
            ...
            for (var c = 0; c < b.length && 100 > c; c++) {
              var d = b[c].src;
              if (d && 0 == d.indexOf("https://web.archive.org/web/20180819202221/https://www.google-analytics.com/analytics")) {
                b = !0;
                break a
              }
            }
